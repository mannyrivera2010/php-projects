...
{
Echo '<Font size = "16"> Error</Font><Br>  Quiz is not recognized';
echo $_POST['QuizID'];
Break;
}
...
if(empty($_POST['name']))
{
echo '<Font size = "16"> Error</Font><BR>  Enter you name';
}
else
mark_questions();
